...
Get-FileHash .\WhatsNow_2.5.0_windows_x64-portable.exe -Algorithm SHA256
```
...
```bash
shasum -a 256 WhatsNow_2.5.0_aarch64.dmg
...
```bash
sha256sum WhatsNow_2.5.0_amd64.AppImage
sha256sum WhatsNow_2.5.0_amd64.deb
```
