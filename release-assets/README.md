...
The Windows subfolder is the v1.1.0 upload staging area. Linux and macOS
packages should be added only after native build and platform validation.

Upload these files to the `v1.1.0` GitHub Release rather than committing the
